...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--print_freq', type=int, default=800, help='frequency of showing training results on console')
        ...
        # training parameters
        parser.add_argument('--niter', type=int, default=75, help='# of iter at starting learning rate')
        parser.add_argument('--niter_decay', type=int, default=75, help='# of iter to linearly decay learning rate to zero')
